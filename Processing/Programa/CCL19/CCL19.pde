...
boolean capta = false;  //Activación de la función para captar coordenadas del ratón
boolean mousePulsado;
...
//Activa captación de coordenadas con ratón
  if (key == 'c'|| key == 'C'){
    if (capta == false) {
     capta = true;
     cursor();
...
//Función de captación de coordenadas del ratón
  if(capta == true & mousePulsado == true){
    println("X "+mouseX);
    println("Y "+mouseY);
  }
  mousePulsado = false;    
